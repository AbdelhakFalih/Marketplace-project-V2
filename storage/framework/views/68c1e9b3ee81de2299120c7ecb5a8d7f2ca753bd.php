                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($stats['users']); ?></div>
                        </div>
                        <div class="col-auto">
    ...
    <script>
        ...
        new Chart(ctx1, {
            ...
            data: {
                ...
                datasets: [{
                    label: 'Transactions',
                    data: [<?php echo e($stats['transactions'] ?? 0); ?>], // Dynamic data
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hp\Application-Marketplace\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>