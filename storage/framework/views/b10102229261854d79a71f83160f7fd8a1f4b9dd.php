            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    ...
                    <div class="d-flex gap-3 flex-wrap">
                        <a href="<?php echo e(route('register')); ?>" class="btn btn-light btn-lg px-4" data-translate="home.cta.start">Commencer</a>
                        <a href="#features" class="btn btn-outline-light btn-lg px-4" data-translate="home.cta.learn">En savoir plus</a>
                    </div>
                </div>
                <div class="col-lg-6 text-center">
                    <img src="<?php echo e(asset('images/market-background.jpg')); ?>?height=400&width=500" alt="Marketplace" class="img-fluid rounded-lg shadow-lg">
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-md-4">
                    <div class="card h-100 border-0 shadow-sm hover:shadow-lg transition-shadow">
                        <div class="card-body text-center p-4">
                            ...
                            <h5 class="card-title font-bold mb-3"><?php echo e(__('Rapide')); ?></h5>
                            <p class="card-text text-gray-600"><?php echo e(__('Interface intuitive et processus optimisés pour une expérience fluide.')); ?></p>
                        </div>
                    </div>s
                </div>
            </div>
    ...
    <section class="py-16 bg-gradient-to-r from-green-600 to-green-400 text-white">
        <div class="container mx-auto px-4 text-center">
            ...
            <div class="d-flex gap-3 justify-content-center flex-wrap">
                <a href="<?php echo e(route('register')); ?>" class="btn btn-light btn-lg px-5" data-translate="home.cta.register">Créer un compte</a>
                <a href="<?php echo e(route('contact')); ?>" class="btn btn-outline-light btn-lg px-5" data-translate="home.cta.contact">Nous contacter</a>
            </div>
        </div>
    </section>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hp\Application-Marketplace\resources\views/home.blade.php ENDPATH**/ ?>