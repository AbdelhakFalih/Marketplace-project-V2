    ...
    <div class="container-fluid">
        <div class="d-flex align-items-center justify-content-between w-11/12" >
            ...
            <div class="d-flex align-items-center">
                <a href="<?php echo e(route('home')); ?>" class="navbar-brand d-flex align-items-center text-decoration-none me-4">
                    ...
                    <button class="btn btn-outline-secondary d-flex align-items-center" type="button" data-bs-toggle="dropdown">
                        <div class="bg-primary rounded-circle p-2 me-2">
                            <?php if(Auth::check() && Auth::user()->avatar): ?>
                                <img src="<?php echo e(Auth::user()->avatar); ?>" alt="Avatar" class="rounded-circle" style="width: 20px; height: 20px;">
                            <?php else: ?>
                                <i class="fas fa-user text-white small"></i>
                            <?php endif; ?>
                        </div>
                        <div class="text-start d-none d-md-block">
                            <div class="fw-bold small"><?php echo e(Auth::user()->name ?? 'Utilisateur'); ?></div>
                            <div class="text-muted small"><?php echo e(Auth::user()->email ?? 'user@example.com'); ?></div>
                        </div>
                        <i class="fas fa-chevron-down ms-2"></i>
                    </button>
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><h6 class="dropdown-header"><?php echo e(Auth::user()->name ?? 'Utilisateur'); ?></h6></li>
                        <li><small class="dropdown-item-text text-muted"><?php echo e(Auth::user()->email ?? 'user@example.com'); ?></small></li>
                        <li><hr class="dropdown-divider"></li>
                        ...
                        <li><hr class="dropdown-divider"></li>
                        <li><a class="dropdown-item text-danger" href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
        ...
        <div class="collapse navbar-collapse mt-3 d-lg-none" id="userNavbar">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->is('user/dashboard') ? 'active fw-bold' : ''); ?>" href="<?php echo e(route('user.dashboard')); ?>">
                        <i class="fas fa-tachometer-alt me-2"></i><span data-translate="nav.dashboard">Dashboard</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->is('user/profile*') ? 'active fw-bold' : ''); ?>" href="<?php echo e(route('user.profile')); ?>">
                        <i class="fas fa-user me-2"></i><span data-translate="nav.profile">Mon Profil</span>
                    </a>
                </li>
                <li class="nav-item">
...
<?php /**PATH C:\Users\hp\Application-Marketplace\resources\views/components/user-navbar.blade.php ENDPATH**/ ?>