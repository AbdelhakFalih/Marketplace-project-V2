    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="<?php echo e(route('offers.index')); ?>" class="btn btn-outline-primary-green">
            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('offers.store')); ?>" enctype="multipart/form-data" id="offerForm">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="category" name="category" required>
                                            ...
                                            <option value="fruits" <?php echo e(old('category') == 'fruits' ? 'selected' : ''); ?>>Fruits</option>
                                            <option value="legumes" <?php echo e(old('category') == 'legumes' ? 'selected' : ''); ?>>Légumes</option>
                                            <option value="cereales" <?php echo e(old('category') == 'cereales' ? 'selected' : ''); ?>>Céréales</option>
                                            <option value="produits-laitiers" <?php echo e(old('category') == 'produits-laitiers' ? 'selected' : ''); ?>>Produits laitiers</option>
                                            <option value="viandes" <?php echo e(old('category') == 'viandes' ? 'selected' : ''); ?>>Viandes</option>
                                            <option value="autres" <?php echo e(old('category') == 'autres' ? 'selected' : ''); ?>>Autres</option>
                                        </select>
...
unset($__errorArgs, $__bag); ?>"
                                          ...
                                          placeholder="Décrivez votre produit: origine, méthode de culture, qualités..."><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" id="unit" name="unit" required>
                                            <option value="">Sélectionner...</option>
                                            <option value="kg" <?php echo e(old('unit') == 'kg' ? 'selected' : ''); ?>>Kilogramme (kg)</option>
                                            <option value="g" <?php echo e(old('unit') == 'g' ? 'selected' : ''); ?>>Gramme (g)</option>
                                            <option value="l" <?php echo e(old('unit') == 'l' ? 'selected' : ''); ?>>Litre (l)</option>
                                            <option value="piece" <?php echo e(old('unit') == 'piece' ? 'selected' : ''); ?>>Pièce</option>
                                            <option value="botte" <?php echo e(old('unit') == 'botte' ? 'selected' : ''); ?>>Botte</option>
                                            <option value="panier" <?php echo e(old('unit') == 'panier' ? 'selected' : ''); ?>>Panier</option>
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="origin" name="origin"
                                               value="<?php echo e(old('origin')); ?>" placeholder="Ex: France, Provence">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="certification" name="certification">
                                            ...
                                            <option value="bio-ab" <?php echo e(old('certification') == 'bio-ab' ? 'selected' : ''); ?>>Bio AB</option>
                                            <option value="demeter" <?php echo e(old('certification') == 'demeter' ? 'selected' : ''); ?>>Demeter</option>
                                            <option value="nature-progres" <?php echo e(old('certification') == 'nature-progres' ? 'selected' : ''); ?>>Nature & Progrès</option>
                                            <option value="ecocert" <?php echo e(old('certification') == 'ecocert' ? 'selected' : ''); ?>>Ecocert</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.user_space', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hp\Application-Marketplace\resources\views/user_space/offers/create.blade.php ENDPATH**/ ?>