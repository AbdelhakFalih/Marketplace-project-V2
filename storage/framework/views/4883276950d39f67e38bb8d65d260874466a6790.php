...
<div class="bg-dark text-white vh-100 position-fixed" style="width: 250px; z-index: 1000;">
    ...
    <nav class="p-3">
        ...
        <!-- Dashboard -->
        <a href="/admin/dashboard" class="nav-link text-white d-flex align-items-center p-2 rounded mb-1 <?php echo e(request()->is('admin/dashboard') ? 'bg-secondary' : ''); ?> hover-bg-secondary">
        ...
        <!-- Commandes -->
        <a href="/admin/orders" class="nav-link text-white d-flex align-items-center justify-content-between p-2 rounded mb-1 <?php echo e(request()->is('admin/orders*') ? 'bg-secondary' : ''); ?> hover-bg-secondary">
            <div class="d-flex align-items-center">
        ...
        <div class="mt-4 pt-3 border-top border-secondary">
            ...
            <a href="/admin/settings" class="nav-link text-white d-flex align-items-center p-2 rounded mb-1 <?php echo e(request()->is('admin/settings*') ? 'bg-secondary' : ''); ?> hover-bg-secondary">
                <i class="fas fa-cog me-2"></i>
                <span>Paramètres</span>
            </a>

            <a href="/admin/logs" class="nav-link text-white d-flex align-items-center p-2 rounded mb-1 <?php echo e(request()->is('admin/logs*') ? 'bg-secondary' : ''); ?> hover-bg-secondary">
...
<?php /**PATH C:\Users\hp\Application-Marketplace\resources\views/components/sidebar.blade.php ENDPATH**/ ?>