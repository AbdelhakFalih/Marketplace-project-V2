...
<head>
    ...
    <title data-translate="site.title"><?php echo $__env->yieldContent('title', 'Marketplace Coopérative'); ?></title>
            ...
            <nav class="flex" aria-label="Breadcrumb">
                <ol class="flex items-center space-x-2">
                    ...
                    <li class="flex items-center">
                        ...
                        <?php if($loop->last): ?>
                            <span class="text-gray-900 font-medium"><?php echo e($breadcrumb['name']); ?></span>
                        <?php else: ?>
                            <a href="<?php echo e($breadcrumb['url']); ?>" class="text-gray-500 hover:text-gray-700"><?php echo e($breadcrumb['name']); ?></a>
                        <?php endif; ?>
                    </li>
...
<?php /**PATH C:\Users\hp\Application-Marketplace\resources\views/layouts/app2.blade.php ENDPATH**/ ?>