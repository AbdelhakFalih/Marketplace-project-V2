    ...
    <div class="container-fluid">
        <div class="d-flex align-items-center justify-content-between w-100">
            ...
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h4 class="mb-0 fw-bold text-dark"><?php echo $__env->yieldContent('page-title', 'Administration'); ?></h4>
                    <small class="text-muted"><?php echo $__env->yieldContent('page-description', 'Gestion de la marketplace'); ?></small>
                </div>
            </div>
                ...
                <div class="dropdown">
                    <button class="btn btn-outline-secondary d-flex align-items-center" type="button" data-bs-toggle="dropdown">
                        ...
                        <div class="text-start d-none d-md-block">
                            <div class="fw-bold small"><?php echo e(Auth::user()->name ?? 'Admin User'); ?></div>
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><h6 class="dropdown-header"><?php echo e(Auth::user()->name ?? 'Admin User'); ?></h6></li>
                        <li><small class="dropdown-item-text text-muted"><?php echo e(Auth::user()->email ?? 'admin@marketplace.ma'); ?></small></li>
                        <li><hr class="dropdown-divider"></li>
...
<?php /**PATH C:\Users\hp\Application-Marketplace\resources\views/components/admin-navbar.blade.php ENDPATH**/ ?>