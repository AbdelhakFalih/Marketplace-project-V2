        ...
        <div class="row">
            ...
            <div class="col-lg-2 col-md-6 mb-4">
                ...
                <ul class="list-unstyled">
                    <li class="mb-2">
                        <a href="{{ route('home') }}" class="text-white hover:text-gray-200 dark:hover:text-gray-300" data-translate="nav.home">Accueil</a>
                    </li>
                    <li class="mb-2">
                        <a href="{{ route('home') }}" class="text-white hover:text-gray-200 dark:hover:text-gray-300" data-translate="nav.products">Produits</a>
                    </li>
                    <li class="mb-2">
                        <a href="{{ route('home') }}" class="text-white hover:text-gray-200 dark:hover:text-gray-300" data-translate="nav.cooperatives">Coopératives</a>
                    </li>
                    <li class="mb-2">
                        <a href="{{ route('home') }}" class="text-white hover:text-gray-200 dark:hover:text-gray-300" data-translate="nav.categories">Catégories</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="col-md-6">
                ...
                <div class="flex gap-3 items-center">
                    <div class="bg-white rounded p-2 dark:bg-gray-700">
                        <img src="{{ asset('images/ssl-secure.png') }}" alt="SSL Secure" class="h-8">
                    </div>
                    <div class="bg-white rounded p-2 dark:bg-gray-700">
                        <img src="{{ asset('images/payment-secure.png') }}" alt="Paiement Sécurisé" class="h-8">
                    </div>
                    <div class="bg-white rounded p-2 dark:bg-gray-700">
                        <img src="{{ asset('images/eco-friendly.png') }}" alt="Éco-responsable" class="h-8">
                    </div>
                </div>
            </div>
        ...
        <div class="row pt-4 border-t border-gray-500 dark:border-gray-600">
            <div class="col-md-6">
                <p class="text-white text-sm mb-0 dark:text-gray-200">
                    © {{ date('Y') }} <span data-translate="site.name">CoopMarket</span>.
